...
This repository contains code used for tests of Bayesian model averaging, as presented in the paper [Improved information criteria for Bayesian model averaging in lattice field theory](http://arxiv.org/abs/2208.14983)  In particular, the code included can be used to generate figures 1-9 of the paper (or re-generate them with different random seeds, if desired.)
